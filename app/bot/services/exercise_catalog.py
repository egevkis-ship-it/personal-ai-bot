...
(русский, английский, разговорный). На выход — строгий JSON:

{"canonical_ru":"Жим штанги лёжа","muscle_group":"chest"}

Правила:
- canonical_ru — короткое каноническое русское название с заглавной буквы
- muscle_group ∈ {chest, back, legs, shoulders, biceps, triceps, core, glutes, calves, forearms, cardio}
- Если упражнение неопределимо — canonical_ru = исходный текст, muscle_group = null
