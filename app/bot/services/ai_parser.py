...
- КВАЛИФИКАТОРЫ веса/стороны — это ПОЯСНЕНИЕ, не множитель: "на руку", "каждой", "одной ногой", \
"на ногу", "по стороне" → target_weight = указанное число (НЕ удваивай: "20 кг на руку" → 20), \
а сам квалификатор добавь в notes упражнения. "компенсация N кг" / "противовес N" (гравитрон, \
ассистированные тренажёры) → target_weight = N (это нагрузка противовеса), и слово — в notes.
...
- КВАЛИФИКАТОРЫ не меняют число веса: "20 кг на руку"/"каждой"/"одной ногой" → weight_kg:20 (не удваивай). "компенсация N кг"/"противовес N" (гравитрон) → weight_kg:N.
...
- КВАЛИФИКАТОРЫ не удваивают вес: "20 кг на руку"/"каждой"/"одной ногой" → weight_kg:20. \
"компенсация N кг"/"противовес N" (гравитрон, ассистированные) → weight_kg:N (нагрузка противовеса)
